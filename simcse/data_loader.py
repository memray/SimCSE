...
from simcse.data_process import passage_prepare_features, hfdataset_prepare_features
    ...
    if hftraining_args.do_train and training_args.train_file:
        ...
        for dataset_name in train_dataset_names:
            if dataset_name.startswith('beir_'):
                ...
                # if pile_dataset == 'Pile-CC':
                #     corpus_jsonl_path = os.path.join('/export/home/data/pretrain/pile/Pile-CC.json')
                # else:
                #     corpus_jsonl_path = os.path.join('/export/home/data/pretrain/pile/pile_dup/', f'{pile_dataset}.json')
