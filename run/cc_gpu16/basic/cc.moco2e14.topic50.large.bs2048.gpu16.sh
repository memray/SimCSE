...
export EXP_NAME=cc.T03b_topic50.moco-2e14.contriever256-special50.bert-large-uncased.avg.dot.q128d128.step100k.bs2048.lr5e5
export PROJECT_DIR=/export/home/exp/search/unsup_dr/cc_gpu16/$EXP_NAME
mkdir -p $PROJECT_DIR
