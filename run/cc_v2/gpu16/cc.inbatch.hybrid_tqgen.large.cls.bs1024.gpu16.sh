...
export EXP_NAME=cc.T0gen.inbatch.contriever256.bert-large-uncased.cls.mlp+none.dot.q128d128.step100k.bs1024.lr5e5
...
nohup python -m torch.distributed.launch --nproc_per_node=16 --master_port=31133 --max_restarts=0 train.py --model_name_or_path bert-large-uncased --arch_type inbatch --pooling cls --q_proj mlp --k_proj none --train_file /export/home/data/search/upr/cc/pilecc_uqg.jsonl --dev_file /export/home/data/pretrain/wiki2021_structure/wiki_psgs_w100.dev.tail2e13.tsv --data_type hf --data_pipeline_name contriever256 --pseudo_query_names "{'T03B-topic':0.2,'T03B-title':0.2,'T03B-absum':0.2,'T03B-exsum':0.2}" --remove_unused_columns False --sim_type dot --projection_size 1024 --output_dir $PROJECT_DIR --cache_dir /export/home/data/pretrain/.cache --max_steps $MAX_STEPS --warmup_steps 10000 --logging_steps 100 --eval_steps 10000 --save_steps 1000000 --per_device_train_batch_size 64 --per_device_eval_batch_size 64  --beir_batch_size 128 --qa_batch_size 32 --dataloader_num_workers $NUM_WORKER --lr_scheduler_type linear --learning_rate5e-5  --max_seq_length 256 --max_q_tokens 128 --max_d_tokens 128 --evaluation_strategy steps --load_best_model_at_end --overwrite_output_dir --do_train --do_eval --run_name $EXP_NAME --fp16 --seed 42 --report_to wandb --wiki_passage_path /export/home/data/search/nq/psgs_w100.tsv --qa_datasets_path /export/home/data/search/nq/qas/*-test.csv,/export/home/data/search/nq/qas/entityqs/test/P*.test.json > $PROJECT_DIR/nohup.log 2>&1 & echo $! > run.pid
