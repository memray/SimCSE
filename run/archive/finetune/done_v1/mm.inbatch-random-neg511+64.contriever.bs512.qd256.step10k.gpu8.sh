...
export EXP_NAME=mm.inbatch-random-neg511+64.arch-inbatch.model-contriever.avg.dot.qd256.step10k.bs512.lr1e5
...
nohup python -m torch.distributed.launch --nproc_per_node=8 --master_port=31133 --max_restarts=0 train.py --model_name_or_path bert-base-uncased --reload_model_from facebook/contriever --finetune true --arch_type inbatch --queue_size 0 --train_file /export/home/data/search/msmarco/msmarco-random10.jsonl  --neg_indices 3 --negative_strategy random --dev_file /export/home/data/pretrain/wiki2021_structure/wiki_psgs_w100.dev.tail2e13.tsv --data_type hf --remove_unused_columns False --sim_type dot --output_dir $PROJECT_DIR --cache_dir /export/home/data/pretrain/.cache --max_steps $MAX_STEPS --warmup_steps 1000 --logging_steps 100 --eval_steps 500 --save_steps $MAX_STEPS --per_device_train_batch_size 64 --per_device_eval_batch_size 64 --beir_batch_size 256 --beir_datasets $BEIR_DATASETS --dataloader_num_workers $NUM_WORKER --learning_rate 1e-5 --max_seq_length 256 --evaluation_strategy steps --load_best_model_at_end --overwrite_output_dir --do_train --do_eval --run_name $EXP_NAME --fp16 --seed 577 --report_to wandb > $PROJECT_DIR/nohup.log 2>&1 & echo $! > run.pid
