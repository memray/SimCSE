...
export EXP_NAME=best_cc.v10_trainer+model.cc+cc.shuffle_twice.moco-2e14.contriever-256-prompt-Qtitle05.bert-base-uncased.avg.dot.maxlen256.step100k.bs512.lr3e5
