...
export EXP_NAME=cc.ExtQ-plm-chunk16.seed47-rerun.inbatch.bert-base-uncased.avg.dot.q128d256.step100k.bs1024.lr5e5
export PROJECT_DIR=/export/home/exp/search/unsup_dr/cc_v1/$EXP_NAME
mkdir -p $PROJECT_DIR
...
nohup python -m torch.distributed.launch --nproc_per_node=8 --master_port=3112 --max_restarts=0 train.py --model_name_or_path bert-base-uncased --arch_type inbatch --q_extract google/t5-small-lm-adapt --num_random_chunk 16 --q_extract_ratio 1.0 --train_file pile_Pile-CC --dev_file /export/home/data/pretrain/wiki2021_structure/wiki_psgs_w100.dev.tail2e13.tsv --data_type hf --data_pipeline_name contriever256 --remove_unused_columns False --sim_type dot --output_dir $PROJECT_DIR --overwrite_output_dir --cache_dir /export/home/data/pretrain/.cache --max_steps $MAX_STEPS --warmup_steps 10000 --logging_steps 100 --eval_steps 10000 --save_steps 1000000 --per_device_train_batch_size 128 --per_device_eval_batch_size 128 --beir_batch_size 256 --dataloader_num_workers $NUM_WORKER --learning_rate 5e-5 --max_q_tokens 128 --max_d_tokens 128 --evaluation_strategy steps --load_best_model_at_end --do_train --do_eval --run_name $EXP_NAME --fp16 --seed 47 --report_to wandb --wiki_passage_path /export/home/data/search/nq/psgs_w100.tsv --qa_datasets_path /export/home/data/search/nq/qas/*-test.csv,/export/home/data/search/nq/qas/entityqs/test/P*.test.json > $PROJECT_DIR/nohup.log 2>&1 & echo $! > run.pid

#export WANDB_RUN_ID=370bk36z
