...
export EXP_NAME=cc-hybrid.Qext50+title20+topic40+exsum40.seed477.inbatch.contriever256-special-titles_special.bert-base-uncased.avg.dot.qd128.step100k.bs1024.lr5e5
