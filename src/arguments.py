...
class CustomTrainingArguments:
    ...
    fine_tuning: bool = field(default=False, metadata={"help": "Is it a fine-tuning dataset or pretraining?"})
    ...
    cap_qd_tokens: bool = field(default=False, metadata={"help": "Whether cap the total length of Q/D after tokenization. "
                                                                 "If true, limit len(q)+len(d) <= max_seq_length, otherwise both are limited to max_seq_length"})
